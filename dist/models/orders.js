...
var OrdersStore = /** @class */ (function () {
    ...
    OrdersStore.prototype.currentOrder = function (userID) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        conn = _a.sent();
                        sql = "SELECT * FROM orders WHERE user_id=\"".concat(userID, "\";");
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        conn = _a.sent();
                        sql = "INSERT INTO order_products (quantity, order_id, product_id) VALUES (".concat(quantity, ", '").concat(orderID, "', '").concat(productID, "');");
                        return [4 /*yield*/, conn.query(sql)];
                    case 2:
                        result = _a.sent();
                        conn.release();
    ...
    OrdersStore.prototype.productsInOrder = function () {
        return __awaiter(this, void 0, void 0, function () {
