...
var UsersStore = /** @class */ (function () {
    ...
    UsersStore.prototype.create = function (firstname, lastname, password) {
        return __awaiter(this, void 0, void 0, function () {
            var conn, encPassword, sql, result, err_3;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 3, , 4]);
                    ...
                    case 1:
                        conn = _a.sent();
                        encPassword = bcrypt_1["default"].hashSync(password + BCRYPT_PASSWORD, parseInt(SALT_ROUNDS));
                        sql = "INSERT INTO users (firstname, lastname, password) VALUES('".concat(firstname, "', '").concat(lastname, "', '").concat(encPassword, "') RETURNING *;");
                        return [4 /*yield*/, conn.query(sql)];
                    case 2:
                        result = _a.sent();
                        conn.release();
