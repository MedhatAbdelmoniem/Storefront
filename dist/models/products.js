...
var ProductsStore = /** @class */ (function () {
    ...
    ProductsStore.prototype.create = function (name, price) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        conn = _a.sent();
                        sql = "INSERT INTO products(name, price) VALUES('".concat(name, "', '").concat(price, "') RETURNING *;");
                        return [4 /*yield*/, conn.query(sql)];
                    case 2:
                        result = _a.sent();
                        conn.release();
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        conn = _a.sent();
                        sql = "DELETE FROM products WHERE id=\"".concat(id, "\";");
                        return [4 /*yield*/, conn.query(sql)];
                    case 2:
                        result = _a.sent();
                        conn.release();
                    ...
                    case 3:
                        err_4 = _a.sent();
                        throw new Error("Cannot delete product , ".concat(err_4));
                    case 4: return [2 /*return*/];
                }
            });
        });
